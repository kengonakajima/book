==============================================
『オンラインゲームを支える技術 -- 壮大なプレイ空間の舞台裏』サンプルゲーム
==============================================


※※※必ずお読みください※※※
●ご注意：
本ファイルREADME.txtは、サンプルゲームのソースコード公開当時
（書籍発売当時2011年4月）の情報をもとに説明を行っていますので、
下記内容紹介や動作環境、ならびに使い方については、
あくまで参考までにご参照ください。
また、サンプルゲームは書籍補助資料として公開したものになります
ので、必ず下記「使用に関するご注意」も合わせてご一読ください。
...
上記、MMOタイプのサンプルゲームで使用している通信ミドルウェア「VCE」は、
㈱スクウェア・エニックスに著作権を含む知的財産権・所有権があります。
書籍『オンラインゲームを支える技術』では業界の技術水準の向上と振興のためとして、
本書ご購入の読者の方に限り、特別にライセンス提供を受けているもので、
...
・収録物、プログラムの内容および使用方法、OSの基本操作等に関して、電話やメールでのお問い合わせを含むサポート業務は一切お受けしておりません。あらかじめご了承の上ご使用ください。
